...
void zmk_hid_mouse_scroll_set(int8_t x, int8_t y) { mouse_report.body.d_wheel = x - y; }
void zmk_hid_mouse_scroll_update(int8_t x, int8_t y) { mouse_report.body.d_wheel += x - y; }
